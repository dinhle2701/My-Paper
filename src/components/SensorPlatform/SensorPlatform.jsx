    ...
    return (
        <div className='sensor-platform container-size mt-12'>
            ...
            <div className="package-loss-rate">
                <img src="/My-Paper/image/package-loss-rate.png" alt="packet-loss-rate" className="mx-auto mt-8" />
                <p className='text-center'>
            ...
            <div className="training-configuration">
                ...
                <img src="/My-Paper/image/visualization-wivi32.png" alt="training-configuration" className="mx-auto mt-8" />
                <p className='text-center'>
