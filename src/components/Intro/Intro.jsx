...
const Intro = () => {
    return (
        <div className='intro container-size mt-12 '>
            <h2 className='text-2xl font-bold mt-8 text-center text-black'>Introduction</h2>
            <p>
            ...
            <p>Figure 1: Architecture of the proposed <b>PRoFENCH</b> multimodal WiFi–Vision sensing framework.</p>
        </div>
    )
}
